                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=> {e.stopPropagation()}} className="text-primary">
                        { !cartItem?.[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-indigo-50 border border-indigo-300 md:w-20 w-16 h-8 rounded text-indigo-600 font-medium hover:text-primary-dull cursor-pointer" onClick={() => addtocart(product._id)} >
                                <img src={assets.cart_icon} alt="cart_icon" />
                                Add
                            </button>
                        ) : (
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-8 bg-primary/25 rounded select-none">
